...
class WebsocketClient
{
    ...
    static function open($host = '', $port = 80, $headers = '', &$error_string = '', $timeout = 10, $ssl = false, $persistant = false, $path = '/', $context = null)
    {
    ...
    static function write($sp, $data, $final = true, $binary = true)
    {
    ...
    static function read($sp, &$error_string = NULL)
    {
        $data = "";
